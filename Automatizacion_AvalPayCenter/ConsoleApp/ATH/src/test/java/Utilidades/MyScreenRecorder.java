...
public class MyScreenRecorder extends ScreenRecorder {
	...
	public static void startRecording(String methodName, File rutaCarpeta, String generarEvidencia) throws Exception
	{
		if (generarEvidencia.equals("SI")) {
			
		
		// File file = new File ("./recordings/");
		//System.out.println("Inicia el proceso de grabación");
		...
		screenRecorder.start();
			...
			System.out.println("NO SE GENERA EVIDENCIA EN VIDEO");
		}
	}
